...
(function($) {
  $.widget("akottr.dragtable", {
    ...
    _generateSortable: function(e) {
      ...
      var sortableHtml = '<ul class="dragtable-sortable" style="position:absolute; width:' + totalWidth + 'px; left: 150px;">';
      // assemble the needed html
      thtb.find('.tr > .th').each(function(i, v) {
        var width_li = $(this).outerWidth();
        var height_li = $('.table-wrap').height();
        sortableHtml += '<li style="width:' + width_li + 'px; height: ' + height_li + 'px;">';
